...
def parse_train_args(manual_args = None):
    ...
    # Dataset
    parser.add_argument('--num_train', type=int, default=450, help='Size of training set')
    parser.add_argument('--num_val', type=int, default=50, help='Size of validation set')
    

    # Model
    parser.add_argument('--num_coupling_layers', type=int, default=5, help='Number of coupling layers in the flow')
